...
<body id="page1">
			...
			<div class="fright">
				...
				<div>
					<ul class="menu">
						...
						<li><a class="active" href="personInfor">个人中心</a>
						</li>
					</ul>
				</div>
			</div>
	...
	<div class="main">
		<div class="headImage">
		<img alt="" class="img-thumbnail" src="headImage/<s:property value="user.userImage"/>" height="200px" width="200px">
		</div>
		<div class="persionInfor">
			<form action="">
				<table bordercolor="#e3e3e3" border="5">
					<tr>
						<!-- class="label label-infod" -->
						<td><span>userName: </span>
						</td>
						<td class="infor"><s:property value="user.userName" />
						</td>
					</tr>
					<tr>
						<td><span>userType: </span></td>
						<td class="infor"><s:if test="user.userType==2">管理员</s:if> <s:elseif
								test="user.userType==1">VIP</s:elseif> <s:else>普通用户</s:else> </span></td>
					</tr>
					<tr>
						<td><span>E-Mail: </span></td>
						<td class="infor"><s:property value="user.userEmail" /></td>
					</tr>
					<tr>
						<td><span>Phone: </span></td>
						<td class="infor">
						<s:if test="user.userPhone==null">请完善信息</s:if>
						<s:else><s:property value="user.userPhone" /></s:else>
						</td>
					</tr>
					<tr>
						<td><span>Birth: </span></td>
						<td class="infor"><s:property value="user.userBirth" /></td>
					</tr>
					<tr>
						<td><span>Information: </span></td>
						<td class="infor"><s:property value="user.userInfor" /></td>
					</tr>
					<tr>
						<td cols pan="2" align="center"><a href="changeInfor!show"><input
								type="button" class="btn btn-primary" value="更改"> </a></td>
					</tr>
				</table>
			</form>
		</div>
